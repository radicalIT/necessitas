...
\gregorioscore{GABC/Antyfony/wt_alleluja.gabc}
...
\vfill
\begin{center}
    \includegraphics[width=140px]{Ryciny/Mszał/laus_deo.jpg}
\end{center}
\clearpage
...
\vfill
\begin{center}
    \includegraphics[width=220px]{Ryciny/Mszał/aniolek5.jpg}
\end{center}
\vfill